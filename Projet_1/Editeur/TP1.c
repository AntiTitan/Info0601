...
int updateFlocon(int mat[][NB_C], int * floc) {
...
void afficheZone(int mat[][NB_C], WINDOW* win) {
    int i,j;
...
void ajouterFlocon(int mat[][NB_C], int* nbf,int *floc){
    int x;
    x = rand() % NB_C + 1;
...
void creerObstacle(int sourisX, int sourisY, int POSX, int POSY, int mat[][NB_C], WINDOW* win) {
    int x, y;
    
    x = sourisX-POSX;  /*COLONNE*/
    y = sourisY-POSY;  /*LIGNE*/
